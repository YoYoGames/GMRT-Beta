...
function check_collision_js(_move_x, _move_y) 
{
	...
	if (place_meeting.call(this, this.x + _move_x, this.y + _move_y, obj_collision))
	{
	...
	var _left_top = tilemap_get_at_pixel(obj_game_manager.collision_tilemap, this.bbox_left + _move_x, this.bbox_top + _move_y);

	// This checks for tile collision at the top-right corner of the instance's mask
	var _right_top = tilemap_get_at_pixel(obj_game_manager.collision_tilemap, this.bbox_right + _move_x, this.bbox_top + _move_y);

	// This checks for tile collision at the bottom-right corner of the instance's mask
	var _right_bottom = tilemap_get_at_pixel(obj_game_manager.collision_tilemap, this.bbox_right + _move_x, this.bbox_bottom + _move_y);

	// This checks for tile collision at the bottom-left corner of the instance's mask
	var _left_bottom = tilemap_get_at_pixel(obj_game_manager.collision_tilemap, this.bbox_left + _move_x, this.bbox_bottom + _move_y);
